...
OffscreenClient::OffscreenClient(std::filesystem::path output_dir,
                                 int width,
                                 int height)
...
void OffscreenClient::GetViewRect([[maybe_unused]] CefRefPtr<CefBrowser> browser,
                                  CefRect& rect) {
...
bool OffscreenClient::OnCertificateError(
...
bool OffscreenClient::WaitForFrameCount(int target,
...
int OffscreenClient::ExecuteDevToolsMethod(
...
bool OffscreenClient::WaitForDevToolsResult(int message_id,
